    ...
    <x-card class="max-w-lg mx-auto mt-24">
        ...
        <form method="POST" action="/listing/{{$listing->id}}" enctype="multipart/form-data">
            ...
            <div class="mb-6">
                ...
                <input type="text" value="{{$listing->company}}" class="border border-gray-200 rounded p-2 w-full"
                    name="company" />
            ...
            <div class="mb-6">
                ...
                <input type="text" value="{{$listing->title}}" class="border border-gray-200 rounded p-2 w-full"
            ...
            <div class="mb-6">
                ...
                <input type="text" value="{{$listing->email}}" class="border border-gray-200 rounded p-2 w-full"
                    name="email" />
            ...
            <div class="mb-6">
                ...
                <input type="text" value="{{$listing->website}}" class="border border-gray-200 rounded p-2 w-full"
                    name="website" />
            ...
            <div class="mb-6">
                ...
                <input type="text" value="{{$listing->tags}}" class="border border-gray-200 rounded p-2 w-full"
